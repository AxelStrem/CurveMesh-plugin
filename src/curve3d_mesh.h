...
private:
	...
	void _generate_edge_vertices(LocalVector<CenterPoint> &center_points, real_t total_length, int radial_segments, float uv2_padding, LocalVector<EdgePoint> &edge_points) const;
	...
	void _generate_triangles(LocalVector<EdgePoint> &edge_points, int radial_segments, PackedVector3Array &points, PackedVector3Array &normals, PackedFloat32Array &tangents, PackedVector2Array &uvs, PackedVector2Array &uv2s, PackedInt32Array &indices) const;
